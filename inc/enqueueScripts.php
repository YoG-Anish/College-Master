...
function collegemaster_enqueue_scripts()
{
    ...
    wp_enqueue_style('collegemaster-bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.css');
    wp_enqueue_style('collegemaster-slick', get_template_directory_uri() . '/assets/css/slick.css');
    wp_enqueue_style('collegemaster-all', get_template_directory_uri() . '/assets/css/all.css');
    wp_enqueue_style('collegemaster-responsive', get_template_directory_uri() . '/assets/css/responsive.css');

    //enqueue script
    wp_enqueue_script('jquery');
    wp_enqueue_script('collegemaster-bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.js', array('jquery'), '', true);
    wp_enqueue_script('collegemaster-slick', get_template_directory_uri() . '/assets/js/slick.js', array('jquery'), '', true);
